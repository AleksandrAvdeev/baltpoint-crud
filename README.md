Тестовое задание для BaltPoint на должность PHP-программист Backend

Задание:
Взаимодействие с eloquent-моделью. Необходимо создать модель, совершенно любую. К ней миграции, форму, список. + Создать seeder (наполнитель), который заполнит таблицу БД (10 записей достаточно). Связанные модели будут плюсом.
